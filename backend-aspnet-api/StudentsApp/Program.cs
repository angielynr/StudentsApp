...
void ConfiguredServices(IServiceCollection services)
{
    ...
    services.AddScoped<IStudentServiceCommands, StudentServiceCommands>();
    services.AddScoped<IStudentsRepositoryCommands, StudentsRepositoryCommands>();
